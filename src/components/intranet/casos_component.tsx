...
const Casos_component = () => {
    ...
    return (
        <section className="    py-2 bg-primary-980 mt-20 lg:mt-10 mx-auto">
                                ...
                                <table className="text-left">
                                    <thead>
                                        <tr className="text-gray-400 bg-primary-700 ">
                                            ...
                                            <th className="font-normal px-3 pt-0 pb-3 border-b border-gray-200 dark:border-gray-800 sm:text-gray-400 text-white">Pagos</th>
            ...
            <div id="modal-cronometro" data-modal-show="true" aria-hidden="true" className="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-0 left-0 right-0 md:inset-0 z-50 flex items-center justify-center">
                <div className="relative w-full max-w-2xl px-4 h-full md:h-auto">
                    <div className="bg-white rounded-lg shadow relative dark:bg-gray-700">
                        <div className="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-600">
                            <h3 className="text-gray-900 text-xl lg:text-2xl font-semibold dark:text-white">
                            ...
                            <button type="button" className="text-gray-400 bg-gray-900 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="modal-cronometro" onClick={
                                () => {
                                    setTime(0);
                                    setIsRunning(false);
                                    const modal = document.getElementById('modal-cronometro');
                        ...
                        <div className="p-6  text-base">
                                <h2 className='text-3xl font-bold text-center text-gray-900 dark:text-white'>{formatTime(time)}</h2>
                                ...
                                <div className='flex justify-between mt-5'>
                                       <div className='space-x-2'>
                                            ...
                                            <button className='bg-secondary-700 hover:bg-secondary-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white dark:bg-secondary-450 dark:hover:bg-secondary-600 dark:focus:ring-blue-800'  onClick={() => setTime(0)}>Reiniciar</button> 
                                       </div>
                                       
                                
                                       <div className='space-x-2'>
                                            <button className='bg-primary-450 hover:bg-primary-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white dark:bg-primary-450 dark:hover:bg-primary-600 dark:focus:ring-blue-800'>Guardar</button>
                                            <button className='bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white dark:bg-gray-500 dark:hover:bg-gray-600 dark:focus:ring-gray-800' onClick={
                                                () => {
                                                    setTime(0);
                                                    setIsRunning(false);
                                                    const modal = document.getElementById('modal-cronometro');
            ...
            <div id="modal-table-pagos" data-modal-show="true" aria-hidden="true" className="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-0 left-0 right-0 md:inset-0 z-50 flex items-center justify-center">
                <div className="relative w-full max-w-2xl px-4 h-full md:h-auto">
                    <div className="bg-white rounded-lg shadow relative dark:bg-gray-700">
                        <div className="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-600">
                            <h3 className="text-gray-900 text-xl lg:text-2xl font-semibold dark:text-white">
                            ...
                            <button type="button" className="text-gray-400 bg-gray-900 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="modal-table-pagos" 
                                onClick={
                                    () => {
                                        const modal = document.getElementById('modal-table-pagos');
                                        modal.classList.add('hidden');
            ...
            <div id="modal-upload-file" data-modal-show="true" aria-hidden="true" className="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-0 left-0 right-0 md:inset-0 z-50 flex items-center justify-center">                 
                        <div className="sm:max-w-lg w-full p-10 bg-primary-980 rounded-xl z-10">
                            <div className="flex items-start justify-between">
                                <button type="button" className="text-gray-400 bg-gray-900 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="modal-upload-file" onClick={
                                    () => {
                                        const modal = document.getElementById('modal-upload-file');
                                        modal.classList.add('hidden');
                                        modal.setAttribute('aria-hidden', 'true');
