    ...
    <div className="py-5">
      <div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className='w-ful'>
            <input type="email" placeholder="Correo electrónico" className=" border border-gray-300 rounded-lg shadow-sm px-4 py-2 mb-4" />
            <br />
            <input type="password" placeholder="Contraseña" className="border border-gray-300 rounded-lg shadow-sm px-4 py-2 mb-4" />
            <br />
