...
import { a as i } from './axios.Cm0UX6qg.js';
const y = () => {
  const [c, x] = s.useState([]),
    [b, t] = s.useState(c);
  s.useState([]), s.useState([]);
  ...
  s.useEffect(() => {
    i.get('http://localhost:4000/usuarios').then((r) => {
      console.log(r.data), x(r.data), t(r.data);
    });
  }, []);
  const m = (r) => {
      o(r);
    ...
    g = async () => {
      try {
        const r = { ...a, dni: parseInt(a.dni), estado: 1, clave: '123456' };
        console.log(r);
        const d = await i.post('http://localhost:4000/usuarios/create', r),
          l = await i.get('http://localhost:4000/usuarios');
        x(l.data), t(l.data);
      } catch (r) {
        console.error(r);
      }
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            ...
                            onChange: (r) => {
                              const d = r.target.value,
                                l = c.filter((n) => n.condicion.includes(d));
                              t(l);
                            },
                          }),
                        ],
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsxs('select', {
                            ...
                            onChange: (r) => {
                              const d = r.target.value,
                                l = c.filter((n) => n.estado === parseInt(d));
                              t(l);
                            },
                            children: [
                              e.jsx('option', {
            ...
            children: [
              e.jsxs('div', {
                ...
                children: [
                  e.jsx('h3', {
                    ...
                    children: 'Ingresar nuevo colaborador',
                  }),
                  e.jsx('button', {
                    type: 'button',
                    className:
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('div', {
                    className:
                      ' flex flex-row w-full bg-gray-100 dark:bg-secondary-800 rounded-md p-4',
                    children: [
                      e.jsxs('div', {
