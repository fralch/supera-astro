import { j as a } from './jsx-runtime.K1e75nIr.js';
import { r as s } from './index.NEDEFKed.js';
import { a as c } from './axios.Cm0UX6qg.js';
import { S as t } from './sweetalert2.all.DleYb7kt.js';
const u = () => {
  const [e, l] = s.useState(''),
    [r, i] = s.useState('');
  s.useEffect(() => {
    localStorage.getItem('userData') && (window.location.href = '/casos');
  }, []);
  const n = async () => {
    if ((console.log('login', e, r), e !== '' && r !== '')) {
      t.fire({
      ...
      try {
        const o = await c.post('http://localhost:4000/usuarios/login', {
          usuario: e,
          clave: r,
        });
        console.log(o.data),
          o.data &&
            (localStorage.setItem('userData', JSON.stringify(o.data)),
    ...
    children: [
      a.jsx('div', {
        ...
        children: a.jsxs('div', {
          ...
          children: [
            a.jsx('h2', {
              className: 'text-3xl text-primary-450 sm:text-3xl font-bold mb-6',
